...
try
{
	...
	foreach($conn->query($stmt) as $row)
	{
		...
		<form class="audForm">
			<table class="editAudTable">
				<tr>
					<td>Theatre Number<br><input type="text" name="theatre_num" class="enterNum" value="'. $row['theatre_num'] .'"/></td>
					...
					<td><br><button class="submitAudChange" type="submit" onclick="return false">Submit</button></td>
					<td style="visibility:hidden;"><input type="text" name="old_entry" class="oldEntry" value="theatre_name=\'' . $theatre_name . '\' and theatre_num=\'' . $row['theatre_num'] . '\'"/></td>
				</tr>
			</table>
		</form>';
		...
		foreach($conn->query($movieStmt) as $movieRow)
		{
			echo '
			<tr class="movieRow">
				<td><input type="text" name="movie_title" class="enterMovie" value="'. $movieRow['movie_title'] .'"/></td>
				<td><input type="text" name="theatre_num" class="theatreNum" value="'. $movieRow['theatre_num'] .'"/></td>
				<td><input type="text" name="start_time" class="startTime" value="'. $movieRow['start_time'] .'"/></td>
				...
				<td><button class="submitMovieChange" type="submit" onclick="return updateMovie(this)">Submit</button></td>
				<td><button class="removeMovie" type="submit" onclick="return false">Remove</button></td>															
			</tr>
			';
		}
			...
			echo '
			<tr>
				<td><input type="text" name="movie_title" class="enterMovie" value="" placeholder="Enter Movie Name..."/></td>
				<td><input type="text" name="theatre_num" class="theatreNum" value="" placeholder="Enter Theatre Number..."/></td>
				<td><input type="text" name="start_time" class="startTime" value="" placeholder="Enter Start Time..."/></td>
				<td><input type="text" name="seats_available" class="seatsAvailable" value="" placeholder="Enter Seats Available..."/></td>
				<td><button class="submitMovieChange" type="submit" onclick="return false">Add</button></td>														
			</tr>
			';
	...
	echo '
		<form class="audForm">
			<table class="editAudTable">
				<tr>
					<td>Theatre Number<br><input type="text" name="theatre_num" class="enterNum" value="" placeholder="Enter Theatre Number..."/></td>
					...
					<td><br><button class="submitAudChange" type="submit" onclick="return false">Add</button></td>
				</tr>
			</table>
		</form>';
	echo '</table>';
